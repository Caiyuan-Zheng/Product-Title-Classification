...
flags.num_classes=192
flags.train_epoch=20
flags.batch_size=512
flags.data_file='dataset-50w-word.pkl'
flags.best_acc=0.0
flags.save_path='ckpt-multi/fasttext-two'
FLAGS=flags
...
def train_fasttext():
    ...
    for e in range(flags.train_epoch):
        ...
        #avg_loss=0
        for x_batch, y_batch in fill_feed_dict(x_train, y_train2, flags.batch_size):
        ...
        t1 = time.time()
        dev_acc,dev_loss = run_eval(classifier, sess,x_test,y_test2)
